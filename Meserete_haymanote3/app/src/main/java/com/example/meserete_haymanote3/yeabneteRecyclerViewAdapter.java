...
public class yeabneteRecyclerViewAdapter extends RecyclerView.Adapter<yeabneteRecyclerViewAdapter.ViewHolder>{
    ...
    public yeabneteRecyclerViewAdapter(Context context, ArrayList<Integer> mImagenames, ArrayList<Integer> mImages, ArrayList<Integer> mdescription) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.yeabnete_view,viewGroup,false);
